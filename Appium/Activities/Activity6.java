...
public class Activity6 {
	...
	public void imageScrollTest() throws InterruptedException {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(
				MobileBy.xpath("//android.view.View/android.view.View[@text='Lazy Loading']")));
		...
		Thread.sleep(5000);
		driver.findElement(
				MobileBy.AndroidUIAutomator("UiScrollable(new UiSelector().scrollable(true)).scrollToEnd(3)"));
		Thread.sleep(3000);

		// Find the number of images shown after scrolling
		numberOfImages = driver.findElementsByXPath("//android.view.View[3]/android.widget.Image");
		System.out.println("Number of image shown currently: " + numberOfImages.size());
