...
public class Activity6 {
	...
	public void login_check_validCred() throws InterruptedException {
		...
		driver.findElement(
				MobileBy.AndroidUIAutomator("UiScrollable(new UiSelector().scrollable(true)).scrollToEnd(5)"));
		Thread.sleep(3000);
		driver.findElementByXPath("//android.view.View[contains(@text,'Popups')]").click();
		Thread.sleep(3000);

		wait.until(ExpectedConditions.elementToBeClickable(MobileBy.xpath("//android.view.View[1]/android.view.View[4]/android.widget.Button")));
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(MobileBy
				.xpath("//android.view.View[2]/android.view.View/android.widget.EditText[1]")));
		driver.findElementByXPath(
				"//android.view.View[2]/android.view.View/android.widget.EditText[1]")
				.sendKeys("admin");
		wait.until(ExpectedConditions.presenceOfElementLocated(MobileBy
				.xpath("//android.view.View[2]/android.view.View/android.widget.EditText[2]")));
		driver.findElementByXPath(
